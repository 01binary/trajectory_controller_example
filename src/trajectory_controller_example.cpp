...
bool trajectory_controller_example::init(hardware_interface::VelocityJointInterface* hw,
                                         ros::NodeHandle& controllerManagerNode, ros::NodeHandle& node)
{
  ...
  actionServer_.reset(new actionlib::ActionServer<control_msgs::FollowJointTrajectoryAction>(
      ...
      std::bind(&trajectory_controller_example::trajectoryCancelCallback, this, std::placeholders::_1), false));
...
void trajectory_controller_example::trajectoryCallback(
...
void trajectory_controller_example::trajectoryCancelCallback(
    actionlib::ActionServer<control_msgs::FollowJointTrajectoryAction>::GoalHandle goal)
{
